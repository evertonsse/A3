...
public class CadastroProdutoTela extends javax.swing.JFrame {
    ...
    public CadastroProdutoTela() {
      ...
      public CadastroProdutoTela(Produto produto) {
        ...
        edtValor.setText(Double.toString(estoque));
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        System.out.println(comboTipos.getSelectedIndex());        
        Produto produto = new Produto(edtDescricao.getText(), valor, comboTipos.getSelectedIndex() );         
